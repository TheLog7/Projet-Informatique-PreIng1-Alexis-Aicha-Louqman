...
void event(UserData* pUserData, Screen* pScreen, Event* pEvt){
    ...
    switch(pUserData->page_Actuelle){
        ...
        case CHOIX_PIVOT :
            arrow_select_ChoixPivot(pUserData, pEvt);
            break;
        ...
        case PLATEAU :
            if (pUserData->pivot == OFF){
                ...
                pivot_select_Plateau(pUserData,pEvt);
            }
            // placeSpawn à l'intérieur
            //fonction pivot (je mets pArrow à 0 quand j'entre dedans et je remet à 1 en sortant)
            break;
        default:
...
void draw(UserData* pUserData, Screen* pScreen){
    ...
    switch(pUserData->page_Actuelle){
        ...
        case CHOIX_NB_JOUEURS :
            ...
            break;
        case CHOIX_PIVOT :
            drawChoixPivot(pUserData, pScreen);
            break;
        case PLATEAU :
